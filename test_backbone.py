...
def test_backbone(num_features, test_dataset, test_loader, device, model_path=params.BEST_MODEL_PATH, model_loader=get_backbone, img_name=params.PLOT_BACKBONE):
