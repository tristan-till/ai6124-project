...
def test_head(device, target=params.TARGET, model_path=params.BEST_MODEL_PATH, baseline_path=params.BL_BEST_MODEL_PATH, genome_path=params.BEST_GENOME_PATH, plot_path=params.EVO_PLOT):
